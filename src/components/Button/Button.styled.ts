...
import { ActivityIndicatorProps, ButtonContainerProps, ColorStyleProps, ContainerProps } from './Button.types';
import { TouchableOpacity } from 'react-native';

const buttonColorStyle = css<ColorStyleProps>`
  background-color: ${({ theme }) => theme.colors.primary};
  ${(props) => props.secondary && `background-color: ${props.theme.colors.secondary};`}
  ${(props) => props.customColor && `background-color: ${props.customColor};`}
  ${(props) => props.inverted && `background-color: ${props.theme.colors.primaryText};`}
  ${(props) => props.inverted && props.secondary && `background-color: ${props.theme.colors.secondaryText};`}

  ${(props) => props.transparent && `background-color: transparent;`}

  ${(props) =>
    props.disabled && !props.transparent && !props.inverted && `background-color: ${props.theme.colors.disabled};`}
...
const textColorStyle = css<ColorStyleProps>`
  ...
  ${(props) => props.transparent && props.secondary && `color: ${props.theme.colors.secondary}`}
  ${(props) => props.inverted && props.secondary && `color: ${props.theme.colors.secondary};`}
  ${(props) => props.inverted && props.customColor && `color: ${props.customColor};`}
  ${(props) => props.transparent && props.customColor && `color: ${props.customColor};`}
  ${(props) => props.disabled && (props.inverted || props.transparent) && `color: ${props.theme.colors.disabled};`}
`;
...
export const Container = styled.View<ContainerProps>`
  ...
  ${(props) => (props.rounded ? `border-radius: ${props.theme.metrics.roundness};` : ``)}
   ${(props) => props.transparent && `border-width: 0px;`}

  ${(props) => props.secondary && `border-color: ${props.theme.colors.secondary};`}
  ${(props) => props.transparent && `border-color: transparent;`}
  ${(props) => props.inverted && `border-color: ${props.theme.colors.primary};`}
  ${(props) => props.inverted && props.secondary && `border-color: ${props.theme.colors.secondary};`}
  ${(props) => props.customColor && `border-color: ${props.customColor};`}
  ${(props) => props.disabled && `border-color: ${props.theme.colors.inputBackground};`}
  ${buttonColorStyle};
`;
...
export const ButtonContainerComprovante = styled(TouchableOpacity).attrs((props) => ({
  borderless: true,
  rippleColor: props.theme.colors.rippleColor,
  underlayColor: props.theme.colors.rippleColor,
}))<ButtonContainerProps>`
